...
export default function UpcomingPaymentCard({
  ...
  return (
    <div
      className={`group relative flex items-center justify-between p-3 sm:p-4 rounded-lg border ${colors.border} hover:bg-gray-50 transition-colors duration-200 cursor-pointer`}
