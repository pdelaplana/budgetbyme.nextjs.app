      ...
      {hasCategories ? (
        ...
        <div className='p-6 text-center'>
          ...
          <p className='text-gray-600 mb-6 max-w-md mx-auto'>
            Start organizing your event budget by creating categories like
            "Venue", "Catering", "Photography", etc. This will help you track
          ...
          <div className='space-y-3'>
            ...
            <div className='text-xs text-gray-500'>
              Popular categories: Venue • Catering • Photography • Flowers •
              Music
            </div>
          </div>
        </div>
