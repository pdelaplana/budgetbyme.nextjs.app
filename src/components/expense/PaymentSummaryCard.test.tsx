...
const createMockPaymentStatus = (overrides?: Partial<PaymentStatus>): PaymentStatus => ({
  totalAmount: 1000,
  paidAmount: 600,
  remainingAmount: 400,
  percentagePaid: 60,
...
describe('PaymentSummaryCard', () => {
  ...
  it('should render progress bar by default', () => {
    const paymentStatus = createMockPaymentStatus();
    const { container } = render(<PaymentSummaryCard paymentStatus={paymentStatus} />);
  ...
  it('should hide progress bar when showProgressBar is false', () => {
    ...
    const { container } = render(
      <PaymentSummaryCard paymentStatus={paymentStatus} showProgressBar={false} />
    );
  ...
  it('should not re-render unnecessarily with same props', () => {
    const paymentStatus = createMockPaymentStatus();
    const { rerender } = render(<PaymentSummaryCard paymentStatus={paymentStatus} />);
  ...
  it('should update when paymentStatus changes', () => {
    ...
    const { rerender } = render(<PaymentSummaryCard paymentStatus={initialPaymentStatus} />);
