  ...
  const executeWithRetry = useCallback(
    async <T>(
      ...
      try {
        ...
        const retryConfig =
          customRetryConfig || CATEGORY_RETRY_CONFIGS[contextName];
