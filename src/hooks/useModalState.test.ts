...
describe('useModalState', () => {
  ...
  describe('delete payments confirmation dialog actions', () => {
    it('should open delete payments confirmation', () => {
      ...
      expect(result.current.state.confirmDialogs.deletePayments.isOpen).toBe(
        true,
      );
      expect(result.current.state.confirmDialogs.deletePayments.isLoading).toBe(
        false,
      );
    });
  ...
  describe('delete expense confirmation dialog actions', () => {
    it('should open delete expense confirmation', () => {
      ...
      expect(result.current.state.confirmDialogs.deleteExpense.isOpen).toBe(
        true,
      );
      expect(result.current.state.confirmDialogs.deleteExpense.isLoading).toBe(
        false,
      );
    });
