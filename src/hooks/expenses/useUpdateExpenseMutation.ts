...
export const useUpdateExpenseMutation = (
  options?: UseUpdateExpenseMutationOptions,
) => {
  ...
  return useMutation({
    ...
    onMutate: async (updateExpenseDto) => {
      ...
      const currentExpense = previousExpenses?.find(
          ...
          if (expense.id === expenseId) {
            return {
              ...
              ...(updateExpenseDto.currency !== undefined && {
                currency: updateExpenseDto.currency as any,
              }),
              ...(updateExpenseDto.categoryId !== undefined && {
                category: {
                  ...
                  color:
                    updateExpenseDto.categoryColor || expense.category.color,
              ...
              ...(updateExpenseDto.attachments !== undefined && {
                attachments: updateExpenseDto.attachments,
              }),
        ...
        const updatedCategories = previousCategories.map((category) => {
            ...
            if (category.id === oldCategoryId) {
              ...
              return {
                ...
                scheduledAmount: Math.max(
                  0,
                  (category.scheduledAmount || 0) - oldAmount,
                ),
              };
          ...
          // If same category but amount changed
            ...
            return {
              ...
              scheduledAmount: Math.max(
                0,
                (category.scheduledAmount || 0) + amountDifference,
              ),
            };
          }
          return category;
